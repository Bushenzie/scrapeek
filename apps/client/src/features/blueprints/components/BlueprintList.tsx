import { type Blueprint, blueprintSchema } from "@scrapeek/shared/blueprint";
import { useQuery } from "@tanstack/react-query";
import { Link } from "@tanstack/react-router";
import { LoaderIcon, PenLine } from "lucide-react";
...
export const BlueprintList = () => {
  ...
  return (
    <div className="flex flex-col">
      {isLoading && <LoadingSpinner size="lg" className="mx-auto" />}
      {data &&
        data.length > 0 &&
        data.map((blueprint) => (
          <Link
