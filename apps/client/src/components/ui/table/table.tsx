...
export const TableHeader: FC<TableHeaderProps> = ({ className, ...props }) => {
  return (
    <thead
      ...
      className={cn("[&_tr]:border-b border-blueprint-400", className)}
      {...props}
    />
  );
};
...
export const TableRow: FC<TableRowProps> = ({ className, ...props }) => {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "hover:bg-blueprint-900 data-[state=selected]:bg-muted border-b transition-colors",
        className
      )}
      {...props}
    />
...
export const TableHead: FC<TableHeadProps> = ({ className, ...props }) => {
  return (
    <th
      ...
      className={cn(
        "text-blueprint-100 h-10 px-2 text-left align-middle font-bold whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
        className
      )}
      {...props}
    />
...
export const TableCell: FC<TableCellProps> = ({ className, ...props }) => {
  return (
    <td
      ...
      className={cn(
        "p-2 align-middle text-blueprint-100 whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
        className
      )}
      {...props}
    />
