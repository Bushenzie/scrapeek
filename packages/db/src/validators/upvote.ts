...
export const upvoteInsertSchema = createInsertSchema(upvote).pick(editableFields).omit(omitFields)

export const upvoteUpdateSchema = createUpdateSchema(upvote).pick(editableFields).omit(omitFields)
